    ...
    var home = h(
      ...
      h(
        ...
        h(
          ...
          h(FlipButton, { idleLabel: "Explore Destinations", activeLabel: "Exploring...", onDone: function () { goTo("destinations"); }, className: "bg-[#2E8B57] hover:bg-[#257a4b] px-7 py-3 rounded-full text-sm font-semibold flex items-center gap-2" }, h(ArrowRight, { size: 16 }))
        )
      )
    );
