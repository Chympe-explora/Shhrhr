  ...
  function App() {
    ...
    var sharedTourCard = SECTIONS.sharedTourCard && h(
      ...
      h(
        ...
        h(FlipButton, { idleLabel: t("bookNow", "Book Now"), activeLabel: activeLabelFor(t("bookNow", "Book Now")), onDone: function () { goToPackage("sharedTour"); }, className: "mt-6 w-full bg-[#2E8B57] hover:bg-[#257a4b] py-3 rounded-full font-medium flex items-center justify-center gap-2" }, h(ArrowRight, { size: 16 }))
      )
    );
    ...
    var privatePackageCard = SECTIONS.privatePackageCard && h(
      ...
      h(
        ...
        h(FlipButton, { idleLabel: t("bookNow", "Book Now"), activeLabel: activeLabelFor(t("bookNow", "Book Now")), onDone: function () { goToPackage("privatePackage"); }, className: "mt-6 w-full bg-[#2E8B57] hover:bg-[#257a4b] py-3 rounded-full font-medium flex items-center justify-center gap-2" }, h(ArrowRight, { size: 16 }))
      )
    );
